...
Finally, let's take a look at how the users given stars compare to the rating (grade) of the route. Here we will also color the routes according to length.
