...
Numpy is essential if you're going to be doing any sort of computation. In the first line of your new notebook, simply put in "import numpy as np". Head on over here for a quick view at arithmetic now available with numpy [Numpy Basics](https://tinyurl.com/3yexnc9v)
